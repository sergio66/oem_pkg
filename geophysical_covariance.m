...
elseif numlays > 0 &numQprofiles > 1
  error('oops, have not yet coded this up for more than 1 gas profile')
end
...
sigma_qst = driver.oem.sigma.qst(daInd);
