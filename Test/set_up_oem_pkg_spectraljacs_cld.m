...
%%%%%%%%%%%%%%%%%%%%%%%%%>>>>>>>>>>>>> for set_up_oem_pkg_spectraljacs_cld
pxPERT(1) = h2p(3000);
pxPERT(2) = 2500;
...
%% now add in cloud stuff
cld = load('/home/sergio/MATLABCODE/RATES_CLOUD/latbin36_avg_cloud_properties.mat');
 cld.xstats(1).ice.amt
error('ooo')
